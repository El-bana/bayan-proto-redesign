...
export function PushCampaignModal({ isOpen, onClose, leads }: Props) {
  const [step, setStep] = useState<1 | 2>(1);
  const [selectedCampaign, setSelectedCampaign] = useState('Europe Campaign 2026');
          ...
          {step === 1 ? (
            <>
              <div className="flex items-center justify-between p-6 pb-2">
                <h2 className="text-xl font-bold text-[#10201C]">Push to existing campaign</h2>
              ...
              <div className="p-6 overflow-y-auto">
                ...
                <div className="mb-8">
                  <label className="block text-sm font-bold text-[#10201C] mb-2">
                  ...
                  >
                    <option>Europe Campaign 2026</option>
                    <option>Q1 Mass Outreach</option>
                  </select>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button 
                    onClick={() => setStep(2)}
                    className="px-8 py-2.5 bg-[#0D8C7C] text-white rounded-lg font-medium hover:bg-[#14B39F] transition-colors"
                  >
                    Save
                  </button>
                </div>
            ...
            <div className="bg-white rounded-xl p-10 flex flex-col items-center text-center">
              ...
              <h2 className="text-[28px] font-bold text-[#10201C] mb-8 leading-snug">
                Are you sure you want to<br/>Re-assign leads to &quot;{selectedCampaign}&quot; campaign?
              </h2>
              
              <div className="text-left w-full mb-10">
                <p className="text-xl text-[#10201C] mb-4">This action will:</p>
                <ul className="list-disc pl-8 text-xl text-[#10201C] space-y-2">
                  <li>Start a new sequence.</li>
                  <li>Create a new email thread.</li>
                  <li>Generate a new subject line.</li>
                  <li>Keep all previous campaign history.</li>
                </ul>
              </div>
